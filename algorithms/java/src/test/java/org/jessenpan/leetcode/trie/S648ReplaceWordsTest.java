 ...
 * @author jessenpan
 */
public class S648ReplaceWordsTest {

    private S648ReplaceWords replaceWords = new S648ReplaceWords();

    @Test
    public void test1() {
        String replacedSentence = replaceWords.replaceWords(Arrays.asList("cat", "bat", "rat"), "the cattle was rattled by the battery");
        Assert.assertEquals("the cat was rat by the bat", replacedSentence);
    }

    @Test
    public void test2() {
        String replacedSentence = replaceWords.replaceWords(Arrays.asList("e", "k", "c", "harqp", "h", "gsafc", "vn", "lqp", "soy", "mr", "x", "iitgm", "sb", "oo", "spj", "gwmly", "iu", "z", "f", "ha", "vds", "v", "vpx", "fir", "t", "xo", "apifm", "tlznm", "kkv", "nxyud", "j", "qp", "omn", "zoxp", "mutu", "i", "nxth", "dwuer", "sadl", "pv", "w", "mding", "mubem", "xsmwc", "vl", "farov", "twfmq", "ljhmr", "q", "bbzs", "kd", "kwc", "a", "buq", "sm", "yi", "nypa", "xwz", "si", "amqx", "iy", "eb", "qvgt", "twy", "rf", "dc", "utt", "mxjfu", "hm", "trz", "lzh", "lref", "qbx", "fmemr", "gil", "go", "qggh", "uud", "trnhf", "gels", "dfdq", "qzkx", "qxw"),
